...
Let us try a different approach and see intuitively how it works. Let us consider the number 1122 for example. Let us take a look at the first combination, 1[1]22 = 122, where we delete 1. The number 122 would be what we get, what if the actual number was 11022 then we would end up with 1022 while the maximum number possible would be 1102. What changed ?
